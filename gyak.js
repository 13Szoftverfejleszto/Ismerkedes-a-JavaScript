...
// Hibakereső felület.
console.log(szam);
// DOM (Document Object Model) segítségével.
document.getElementById('pelda').innerText = szam;
// BOM (Browser Object Model) segítségével.
// Modális ablakban (modal window) jelenik meg.
window.alert(szam);
*/

/* window.confirm modális függvény, boolean értékkel tér vissza! */
/*
...
/* window.prompt modális függvény, szövegértékkel (string) tér vissza! */
...
let maiNap = window.prompt('A hét hanyadik napja van?', 1);
